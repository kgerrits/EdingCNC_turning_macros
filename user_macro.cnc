...
;; threading macro
	...
	;; check standard thread table for finding thread minor diameter
	#1558 = 0 ;; set to 1 if thread minor diameter is found in standard table
	
	;; check pitch
	if [#1554 == 0.2] ;; pitch = 0.2
		if [#1552 == 1.0] ;; M1.0 x 0.20
			#1553 = 0.755
			#1558 = 1
		endif	
		if [#1552 == 1.1] ;; M1.1 x 0.20
			#1553 = 0.855
			#1558 = 1
		endif
		if [#1552 == 1.2] ;; M1.2 x 0.20
			#1553 = 0.955
			#1558 = 1
		endif	
		if [#1552 == 1.4] ;; M1.4 x 0.20
			#1553 = 1.155
			#1558 = 1
		endif
		if [#1552 == 1.6] ;; M1.6 x 0.20
			#1553 = 1.355
			#1558 = 1
		endif		
		if [#1552 == 1.8] ;; M1.8 x 0.20
			#1553 = 1.555
			#1558 = 1
		endif			
	endif
	if [#1554 == 0.25] ;; pitch = 0.25
		if [#1552 == 1.0] ;; M1.0 x 0.25
			#1553 = 0.693
			#1558 = 1
		endif
		if [#1552 == 1.1] ;; M1.1 x 0.25
			#1553 = 0.793
			#1558 = 1
		endif
		if [#1552 == 1.2] ;; M1.2 x 0.25
			#1553 = 0.893
			#1558 = 1
		endif
		if [#1552 == 2.0] ;; M2.0 x 0.25
			#1553 = 1.693
			#1558 = 1
		endif
		if [#1552 == 2.2] ;; M2.2 x 0.25
			#1553 = 1.893
			#1558 = 1
		endif		
	endif
	if [#1554 == 0.30] ;; pitch = 0.30
		if [#1552 == 1.4] ;; M1.4 x 0.30
			#1553 = 1.032
			#1558 = 1
		endif	
	endif
	if [#1554 == 0.35] ;; pitch = 0.35
		if [#1552 == 1.6] ;; M1.6 x 0.35
			#1553 = 1.171
			#1558 = 1
		endif
		if [#1552 == 1.8] ;; M1.8 x 0.35
			#1553 = 1.371
			#1558 = 1
		endif
		if [#1552 == 2.5] ;; M2.5 x 0.35
			#1553 = 2.071
			#1558 = 1
		endif
		if [#1552 == 3.0] ;; M3.0 x 0.35
			#1553 = 2.571
			#1558 = 1
		endif	
		if [#1552 == 3.5] ;; M3.5 x 0.35
			#1553 = 3.071
			#1558 = 1
		endif			
	endif
	if [#1554 == 0.4] ;; pitch = 0.4
		if [#1552 == 2.0] ;; M2.0 x 0.4
			#1553 = 1.509
			#1558 = 1
		endif		
	endif	
	if [#1554 == 0.45] ;; pitch = 0.45
		if [#1552 == 2.2] ;; M2.2 x 0.45
			#1553 = 1.648
			#1558 = 1
		endif		
	endif		
	if [#1554 == 0.5] ;; pitch = 0.5
		if [#1552 == 2.5] ;; M2.5 x 0.5
			#1553 = 1.948
			#1558 = 1
		endif
		if [#1552 == 3.0] ;; M3.0 x 0.5
			#1553 = 2.387
			#1558 = 1
		endif	
		if [#1552 == 4.0] ;; M4.0 x 0.5
			#1553 = 3.387
			#1558 = 1
		endif
		if [#1552 == 4.5] ;; M4.5 x 0.5
			#1553 = 3.887
			#1558 = 1
		endif
		if [#1552 == 5.0] ;; M5.0 x 0.5
			#1553 = 4.387
			#1558 = 1
		endif
		if [#1552 == 5.5] ;; M5.5 x 0.5
			#1553 = 4.887
			#1558 = 1
		endif		
	endif
	if [#1554 == 0.6] ;; pitch = 0.6
		if [#1552 == 3.5] ;; M3.5 x 0.6
			#1553 = 2.764
			#1558 = 1
		endif	
	endif	
	if [#1554 == 0.70] ;; pitch = 0.70
		if [#1552 == 4.0] ;; M4.0 x 0.7
			#1553 = 3.141
			#1558 = 1
		endif		
	endif	
	if [#1554 == 0.75] ;; pitch = 0.75
		if [#1552 == 4.5] ;; M4.5 x 0.75
			#1553 = 3.580
			#1558 = 1
		endif
		if [#1552 == 6.0] ;; M6.0 x 0.75
			#1553 = 5.080
			#1558 = 1
		endif
		if [#1552 == 7.0] ;; M7.0 x 0.75
			#1553 = 6.080
			#1558 = 1
		endif
		if [#1552 == 8.0] ;; M8.0 x 0.75
			#1553 = 7.080
			#1558 = 1
		endif
		if [#1552 == 9.0] ;; M9.0 x 0.75
			#1553 = 8.080
			#1558 = 1
		endif
		if [#1552 == 10.0] ;; M10.0 x 0.75
			#1553 = 9.080
			#1558 = 1
		endif
		if [#1552 == 11.0] ;; M11.0 x 0.75
			#1553 = 10.080
			#1558 = 1
		endif		
	endif
	if [#1554 == 0.8] ;; pitch = 0.8
		if [#1552 == 5.0] ;; M5.0 x 0.8
			#1553 = 4.019
			#1558 = 1
		endif	
	endif	
	if [#1554 == 1.0] ;; pitch = 1.0
		if [#1552 == 6.0] ;; M6.0 x 1.0
			#1553 = 4.773
			#1558 = 1
		endif		
		if [#1552 == 7.0] ;; M7.0 x 1.0
			#1553 = 5.773
			#1558 = 1
		endif
		if [#1552 == 8.0] ;; M8.0 x 1.0
			#1553 = 6.773
			#1558 = 1
		endif
		if [#1552 == 9.0] ;; M9.0 x 1.0
			#1553 = 7.773
			#1558 = 1
		endif
		if [#1552 == 10.0] ;; M10.0 x 1.0
			#1553 = 8.773
			#1558 = 1
		endif
		if [#1552 == 11.0] ;; M11.0 x 1.0
			#1553 = 9.773
			#1558 = 1
		endif
		if [#1552 == 12.0] ;; M12.0 x 1.0
			#1553 = 10.773
			#1558 = 1
		endif
		if [#1552 == 14.0] ;; M14.0 x 1.0
			#1553 = 12.773
			#1558 = 1
		endif
		if [#1552 == 15.0] ;; M15.0 x 1.0
			#1553 = 13.773
			#1558 = 1
		endif
		if [#1552 == 16.0] ;; M16.0 x 1.0
			#1553 = 14.773
			#1558 = 1
		endif
		if [#1552 == 17.0] ;; M17.0 x 1.0
			#1553 = 15.773
			#1558 = 1
		endif
		if [#1552 == 18.0] ;; M18.0 x 1.0
			#1553 = 16.773
			#1558 = 1
		endif
		if [#1552 == 20.0] ;; M20.0 x 1.0
			#1553 = 18.773
			#1558 = 1
		endif
		if [#1552 == 22.0] ;; M22.0 x 1.0
			#1553 = 20.773
			#1558 = 1
		endif
		if [#1552 == 24.0] ;; M24.0 x 1.0
			#1553 = 22.773
			#1558 = 1
		endif
		if [#1552 == 25.0] ;; M25.0 x 1.0
			#1553 = 23.773
			#1558 = 1
		endif
		if [#1552 == 27.0] ;; M27.0 x 1.0
			#1553 = 25.773
			#1558 = 1
		endif
		if [#1552 == 28.0] ;; M28.0 x 1.0
			#1553 = 26.773
			#1558 = 1
		endif		
	endif
	if [#1554 == 1.25] ;; pitch = 1.25
		if [#1552 == 8.0] ;; M8.0 x 1.25
			#1553 = 6.466
			#1558 = 1
		endif	
		if [#1552 == 9.0] ;; M9.0 x 1.25
			#1553 = 7.466
			#1558 = 1
		endif
		if [#1552 == 10.0] ;; M10.0 x 1.25
			#1553 = 8.466
			#1558 = 1
		endif
		if [#1552 == 12.0] ;; M12.0 x 1.25
			#1553 = 10.466
			#1558 = 1
		endif
		if [#1552 == 14.0] ;; M14.0 x 1.25
			#1553 = 12.466
			#1558 = 1
		endif		
	endif
	if [#1554 == 1.5] ;; pitch = 1.5
		if [#1552 == 10.0] ;; M10.0 x 1.5
			#1553 = 8.160
			#1558 = 1
		endif		
		if [#1552 == 11.0] ;; M11.0 x 1.5
			#1553 = 9.160
			#1558 = 1
		endif
		if [#1552 == 12.0] ;; M12.0 x 1.5
			#1553 = 10.160
			#1558 = 1
		endif
		if [#1552 == 14.0] ;; M14.0 x 1.5
			#1553 = 12.160
			#1558 = 1
		endif
		if [#1552 == 15.0] ;; M15.0 x 1.5
			#1553 = 13.160
			#1558 = 1
		endif
		if [#1552 == 16.0] ;; M16.0 x 1.5
			#1553 = 14.160
			#1558 = 1
		endif
		if [#1552 == 17.0] ;; M17.0 x 1.5
			#1553 = 15.160
			#1558 = 1
		endif
		if [#1552 == 18.0] ;; M18.0 x 1.5
			#1553 = 16.160
			#1558 = 1
		endif
		if [#1552 == 20.0] ;; M20.0 x 1.5
			#1553 = 18.160
			#1558 = 1
		endif
		if [#1552 == 22.0] ;; M22.0 x 1.5
			#1553 = 20.160
			#1558 = 1
		endif
		if [#1552 == 24.0] ;; M24.0 x 1.5
			#1553 = 22.160
			#1558 = 1
		endif
		if [#1552 == 25.0] ;; M25.0 x 1.5
			#1553 = 23.160
			#1558 = 1
		endif
		if [#1552 == 27.0] ;; M27.0 x 1.5
			#1553 = 25.160
			#1558 = 1
		endif
		if [#1552 == 28.0] ;; M28.0 x 1.5
			#1553 = 26.160
			#1558 = 1
		endif		
	endif
	if [#1554 == 1.75] ;; pitch = 1.75
		if [#1552 == 12.0] ;; M12.0 x 1.75
			#1553 = 9.853
			#1558 = 1
		endif		
	endif	
	if [#1554 == 2.0] ;; pitch = 2.0
		if [#1552 == 14.0] ;; M14.0 x 2.0
			#1553 = 11.546
			#1558 = 1
		endif	
		if [#1552 == 16.0] ;; M16.0 x 2.0
			#1553 = 13.546
			#1558 = 1
		endif
		if [#1552 == 18.0] ;; M18.0 x 2.0
			#1553 = 15.546
			#1558 = 1
		endif
		if [#1552 == 20.0] ;; M20.0 x 2.0
			#1553 = 17.546
			#1558 = 1
		endif
		if [#1552 == 22.0] ;; M22.0 x 2.0
			#1553 = 19.546
			#1558 = 1
		endif
		if [#1552 == 24.0] ;; M24.0 x 2.0
			#1553 = 21.546
			#1558 = 1
		endif
		if [#1552 == 25.0] ;; M25.0 x 2.0
			#1553 = 22.546
			#1558 = 1
		endif
		if [#1552 == 27.0] ;; M27.0 x 2.0
			#1553 = 24.546
			#1558 = 1
		endif
		if [#1552 == 28.0] ;; M28.0 x 2.0
			#1553 = 25.546
			#1558 = 1
		endif		
	endif
	if [#1554 == 2.5] ;; pitch = 2.5
		if [#1552 == 18.0] ;; M18.0 x 2.5
			#1553 = 14.993
			#1558 = 1
		endif	
		if [#1552 == 20.0] ;; M20.0 x 2.5
			#1553 = 16.993
			#1558 = 1
		endif	
		if [#1552 == 22.0] ;; M22.0 x 2.5
			#1553 = 18.993
			#1558 = 1
		endif	
	endif	
	if [#1554 == 3.0] ;; pitch = 3.0
		if [#1552 == 24.0] ;; M24.0 x 3.0
			#1553 = 20.319
			#1558 = 1
		endif		
		if [#1552 == 27.0] ;; M27.0 x 3.0
			#1553 = 23.319
			#1558 = 1
		endif				
	endif
	if [#1554 == 3.5] ;; pitch = 3.5
		if [#1552 == 30.0] ;; M30.0 x 3.5
			#1553 = 25.706
			#1558 = 1
		endif	
		if [#1552 == 33.0] ;; M33.0 x 3.5
			#1553 = 28.706
			#1558 = 1
		endif			
	endif		
	if [#1554 == 4.0] ;; pitch = 4.0
		if [#1552 == 36.0] ;; M36.0 x 4.0
			#1553 = 31.093
			#1558 = 1
		endif	
		if [#1552 == 39.0] ;; M39.0 x 4.0
			#1553 = 34.093
			#1558 = 1
		endif		
	endif	
	...
	;; --------------------
	if [#1558 == 1]
		;; thread found in table
		msg "Thread minor diameter: "#1553
	else
		errmsg "Nominal thread size and pitch combination not found in table"
	endif
	
	#1558 = 0 ;; set to 0 for check in next threading cycle
